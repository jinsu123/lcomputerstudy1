...
<body>
	...
	<form action="/board/editProcess" name="board" method="post">
		<input type="hidden" name="b_idx" value="${board.bId}">
		...
		<p> <div style="text-align:middle">내   용 :</div><textarea  style="overflow:auto; height:150px; resize:none;"  cols="100	" rows="100" name="bContent" value="${board.bContent }"></textarea>
